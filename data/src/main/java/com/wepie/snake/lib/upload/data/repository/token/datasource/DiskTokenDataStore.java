...
class DiskTokenDataStore implements TokenDataStore {
    ...
    @Override
    public <Token extends TokenBase, Param extends UploadParam<Token>> void get(Param param, CallBack<Token> callBack) {
        callBack.onSuccess((Token) tokenCache.get(""));
    }
}
