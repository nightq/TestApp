...
/**
 */
public interface UploadRestApi<Token extends TokenBase, Param extends UploadParam<Token>, Result extends UploadResult> {

    void put(Param uploadParam, CallBack<Result> callBack);
}
