package com.wepie.scanlib.zxing.utils;
...
public final class Encoder {
    ...
    public Bitmap encode(final String content, int width, int height){
        ...
        if(mConfigBuilder.mErrorCorrectionLevel != null){
            hints.put(EncodeHintType.ERROR_CORRECTION, mConfigBuilder.mErrorCorrectionLevel); // 容错级别设置
        }
    ...
    public static class Builder{
        ...
        private ErrorCorrectionLevel mErrorCorrectionLevel = ErrorCorrectionLevel.M;
